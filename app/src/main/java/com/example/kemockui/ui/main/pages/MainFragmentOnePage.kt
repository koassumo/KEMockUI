...
import com.example.kemockui.ui.main.RvAdapterCommon

class MainFragmentOnePage : Fragment() {

    companion object {
        fun newInstance() = MainFragmentOnePage()
    }

    private lateinit var viewModel: MainOnePageViewModel
    ...
    private var _binding: MainFragmentOnePageBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = MainFragmentOnePageBinding.bind(view)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewModel = ViewModelProvider(this).get(MainOnePageViewModel::class.java)
